...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://tripmania-backend.onrender.com/api/v1/signup', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="sm:mx-auto sm:w-full sm:max-w-md mb-10">
          <h2 className="text-center text-3xl font-extrabold text-gray-900">Signup As User</h2>
        </div>
